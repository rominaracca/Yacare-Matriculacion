...
window.onload = function(){
    ...
    image.src = 'images/nico-perfil.jpg';

    // creating canvas and context objects
    canvas = document.getElementById('picturePanel');
    ctx = canvas.getContext('2d');

    // create initial selection
    theSelection = new Selection(200, 200, 200, 200);

    $('#picturePanel').mousemove(function(e) { // binding mouse move event
    ...
    $('#picturePanel').mousedown(function(e) { // binding mousedown event
        var canvasOffset = $(canvas).offset();
        iMouseX = Math.floor(e.pageX - canvasOffset.left);
        iMouseY = Math.floor(e.pageY - canvasOffset.top);
    ...
    $('#picturePanel').mouseup(function(e) { // binding mouseup event
